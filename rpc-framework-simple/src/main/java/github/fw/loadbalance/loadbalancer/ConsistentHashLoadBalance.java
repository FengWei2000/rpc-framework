package github.fw.loadbalance.loadbalancer;

import github.fw.loadbalance.AbstractLoadBalance;
...
public class ConsistentHashLoadBalance extends AbstractLoadBalance {
    ...
    protected String doSelect(List<String> serviceAddresses, RpcRequest rpcRequest) {
        int identityHashCode = System.identityHashCode(serviceAddresses);   // 返回hashCode
    ...
    static class ConsistentHashSelector {
        ...
        ConsistentHashSelector(List<String> invokers, int replicaNumber, int identityHashCode) {
            this.virtualInvokers = new TreeMap<>();     // 虚拟节点
            ...
            for (String invoker : invokers) {
                for (int i = 0; i < replicaNumber / 4; i++) {
                    ...
                    for (int h = 0; h < 4; h++) {
                        ...
                        virtualInvokers.put(m, invoker);    // value是服务提供地址
                    }
                }
            }
        }
